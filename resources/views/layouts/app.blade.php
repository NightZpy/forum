                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @if (auth()->check())
                                <li><a href="{{ route('threads.index.by-user', \Auth::user()->name) }}">My threads</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                           aria-haspopup="true" aria-expanded="false">Sort by <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('threads.index.sort-by-popularity', [], false) }}">Popularity</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
